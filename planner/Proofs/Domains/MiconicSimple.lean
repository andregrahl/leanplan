...
/-
Miconic, simple heuristic: goal-aware, consistent, admissible.

Only `depart` adds a `served` atom, for a single passenger.
...
theorem simple_goalAware (t : Task) (hwf : Task.WF t)
  ...
  (t.maxMissingOf_admissible hwf "miconic-simple" [["served"]] hcert).1

theorem simple_consistent (t : Task) (hwf : Task.WF t)
    (hcert : certified t = true) : t.Consistent (simple t).eval :=
  (t.maxMissingOf_admissible hwf "miconic-simple" [["served"]] hcert).2.1
...
theorem simple_admissible (t : Task) (hwf : Task.WF t)
  ...
  (t.maxMissingOf_admissible hwf "miconic-simple" [["served"]] hcert).2.2
...
theorem simple_goalAware_of_schema (t : Task) (hwf : Task.WF t)
  ...
  (t.maxMissingOf_admissible_of_schema hwf "miconic-simple"
    [["served"]] hgnd hsafe).1
