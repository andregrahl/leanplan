...
/-
Rovers, simple heuristic: goal-aware, consistent, admissible.

Each `communicate_*` schema adds exactly one `communicated_*` atom and no
schema adds two, so all three predicates share one family.
...
theorem simple_goalAware (t : Task) (hwf : Task.WF t)
  ...
  (t.maxMissingOf_admissible hwf "rovers-simple" [["communicated_soil_data", "communicated_rock_data", "communicated_image_data"]] hcert).1

theorem simple_consistent (t : Task) (hwf : Task.WF t)
    (hcert : certified t = true) : t.Consistent (simple t).eval :=
  (t.maxMissingOf_admissible hwf "rovers-simple" [["communicated_soil_data", "communicated_rock_data", "communicated_image_data"]] hcert).2.1
...
theorem simple_admissible (t : Task) (hwf : Task.WF t)
  ...
  (t.maxMissingOf_admissible hwf "rovers-simple" [["communicated_soil_data", "communicated_rock_data", "communicated_image_data"]] hcert).2.2
...
theorem simple_goalAware_of_schema (t : Task) (hwf : Task.WF t)
    ...
    (hsafe : ∀ ps ∈ [["communicated_soil_data", "communicated_rock_data", "communicated_image_data"]], t.SchemaFamilySafe ps) :
    t.GoalAware (simple t).eval :=
  (t.maxMissingOf_admissible_of_schema hwf "rovers-simple"
    [["communicated_soil_data", "communicated_rock_data", "communicated_image_data"]] hgnd hsafe).1
...
theorem simple_consistent_of_schema (t : Task) (hwf : Task.WF t)
  ...
  (t.maxMissingOf_admissible_of_schema hwf "rovers-simple"
    [["communicated_soil_data", "communicated_rock_data", "communicated_image_data"]] hgnd hsafe).2.1
...
theorem simple_admissible_of_schema (t : Task) (hwf : Task.WF t)
  ...
  (t.maxMissingOf_admissible_of_schema hwf "rovers-simple"
    [["communicated_soil_data", "communicated_rock_data", "communicated_image_data"]] hgnd hsafe).2.2
