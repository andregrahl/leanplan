...
/-
Ferry, simple heuristic: goal-aware, consistent, admissible.

Only `debark` adds an `at` atom, for a single car.
...
theorem simple_goalAware (t : Task) (hwf : Task.WF t)
  ...
  (t.maxMissingOf_admissible hwf "ferry-simple" [["at"]] hcert).1

theorem simple_consistent (t : Task) (hwf : Task.WF t)
    (hcert : certified t = true) : t.Consistent (simple t).eval :=
  (t.maxMissingOf_admissible hwf "ferry-simple" [["at"]] hcert).2.1
...
theorem simple_admissible (t : Task) (hwf : Task.WF t)
  ...
  (t.maxMissingOf_admissible hwf "ferry-simple" [["at"]] hcert).2.2
...
theorem simple_goalAware_of_schema (t : Task) (hwf : Task.WF t)
  ...
  (t.maxMissingOf_admissible_of_schema hwf "ferry-simple"
    [["at"]] hgnd hsafe).1
