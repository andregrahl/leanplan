...
/-
Satellite, simple heuristic: goal-aware, consistent, admissible.

`take_image` adds one `have_image` atom and no `pointing` atom, `turn_to` one
`pointing` atom and no `have_image` atom, so the two predicates share one family.
...
theorem simple_goalAware (t : Task) (hwf : Task.WF t)
  ...
  (t.maxMissingOf_admissible hwf "satellite-simple" [["have_image", "pointing"]] hcert).1

theorem simple_consistent (t : Task) (hwf : Task.WF t)
    (hcert : certified t = true) : t.Consistent (simple t).eval :=
  (t.maxMissingOf_admissible hwf "satellite-simple" [["have_image", "pointing"]] hcert).2.1
...
theorem simple_admissible (t : Task) (hwf : Task.WF t)
  ...
  (t.maxMissingOf_admissible hwf "satellite-simple" [["have_image", "pointing"]] hcert).2.2
...
theorem simple_goalAware_of_schema (t : Task) (hwf : Task.WF t)
    ...
    (hsafe : ∀ ps ∈ [["have_image", "pointing"]], t.SchemaFamilySafe ps) :
    t.GoalAware (simple t).eval :=
  (t.maxMissingOf_admissible_of_schema hwf "satellite-simple"
    [["have_image", "pointing"]] hgnd hsafe).1
...
theorem simple_consistent_of_schema (t : Task) (hwf : Task.WF t)
  ...
  (t.maxMissingOf_admissible_of_schema hwf "satellite-simple"
    [["have_image", "pointing"]] hgnd hsafe).2.1
...
theorem simple_admissible_of_schema (t : Task) (hwf : Task.WF t)
  ...
  (t.maxMissingOf_admissible_of_schema hwf "satellite-simple"
    [["have_image", "pointing"]] hgnd hsafe).2.2
